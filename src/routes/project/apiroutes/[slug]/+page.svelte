<script lang="ts">
    ...
    import ApirouteToolBar from "$lib/components/apiroutes/apirouteToolBar.svelte";
    import CardTemplate from "$lib/components/apiroutes/cardTemplate.svelte";
...
<Sidebar.Provider>
	...
	<Sidebar.Inset>
			...
			<div class="flex items-center gap-2">
				...
				<Breadcrumb.Root>
					<Breadcrumb.List>
						...
						<Breadcrumb.Item>
							<Breadcrumb.Page>Api routes</Breadcrumb.Page>
						</Breadcrumb.Item>
                        <Breadcrumb.Separator class="hidden md:block" />
						<Breadcrumb.Item>
		...
		<div class="flex flex-1 flex-col gap-2 px-2 xl:p-4 py-4">
            <ApirouteToolBar bind:value={searchQuery}/>
            <CardTemplate searchdata={searchQuery}/>
		</div>
	</Sidebar.Inset>
</Sidebar.Provider>
