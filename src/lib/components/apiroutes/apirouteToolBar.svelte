...
<div class=" w-full ">
    <div class="w-full bg-zinc-900 backdrop-blur-lg h-9 flex justify-between rounded-lg border">
        <div class="flex items-center gap-2 py-0.5 px-2 w-90">
            ...
            <div class="flex gap-2">
                <Button class="h-6 text-xs p-1 bg-transparent text-white hover:bg-zinc-900">
